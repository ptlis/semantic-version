...
class SpecificLabelTest extends TestCase
{
    public function testAbsent()
    {
        ...
        $this->assertEquals(Label::PRECEDENCE_ABSENT, $label->getPrecedence());
    }
    ...
    public function testDev()
    {
        ...
        $this->assertEquals(strval($label), 'bob');

        $this->assertEquals(Label::PRECEDENCE_DEV, $label->getPrecedence());
    }
    ...
    public function testDevWithVersion()
    {
        ...
        $this->assertEquals(strval($label), 'bob.3');
    }
    ...
    public function testAlpha()
    {
        ...
        $this->assertEquals(strval($label), 'alpha');
        $this->assertEquals(Label::PRECEDENCE_ALPHA, $label->getPrecedence());
    }
    ...
    public function testAlphaWithVersion()
    {
        ...
        $this->assertEquals(strval($label), 'alpha.5');
    }
    ...
    public function testBeta()
    {
        ...
        $this->assertEquals(strval($label), 'beta');
        $this->assertEquals(Label::PRECEDENCE_BETA, $label->getPrecedence());
    }
    ...
    public function testBetaWithVersion()
    {
        ...
        $this->assertEquals(strval($label), 'beta.2');
    }
    ...
    public function testRc()
    {
        ...
        $this->assertEquals(strval($label), 'rc');
    ...
    public function testRcWithVersion()
    {
        ...
        $this->assertEquals(strval($label), 'rc.2');
    }
}
